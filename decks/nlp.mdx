...
### Conversation between two or more people (interlocutors). The dialogue strategy (or dialogue policy) of a dialogue system decides on which action the system should perform at a given state in the dialogue.
</L.Row>
